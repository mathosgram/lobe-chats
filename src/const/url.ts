...
export const DISCORD = 'https://chat.imoogleai.xyz';
export const PRIVACY_URL = urlJoin(OFFICIAL_SITE, '/privacy');
export const TERMS_URL = urlJoin(OFFICIAL_SITE, '/terms');

export const PLUGINS_INDEX_URL = 'https://chat.imoogleai.xyz.com';
...
export const AGENTS_INDEX_GITHUB = 'https://chat.imoogleai.xyz';
...
export const MEDIDUM = 'https://chat.imoogleai.xyz';
export const X = 'https://chat.imoogleai.xyz';
export const RELEASES_URL = urlJoin(GITHUB, 'releases');

export const mailTo = (email: string) => `mailto:${email}`;

export const AES_GCM_URL = 'https://datatracker.ietf.org/doc/html/draft-ietf-avt-srtp-aes-gcm-01';
export const BASE_PROVIDER_DOC_URL = 'https://chat.imoogleai.xyz';
